...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        BottleOfJuice bottleOfJuice1 = new BottleOfJuice("Multon", "Rich", "apple", 130, 0.5);
        System.out.println(bottleOfJuice1.displayInfo());

        CandyBar candyBar1 = new CandyBar("Nestle", "Nuts Duo", "nuts/nougat", 100, 60, 483);
        System.out.println(candyBar1.displayInfo());

        BagOfChips bagOfChips1 = new BagOfChips("PepsiCo", "Lay's", "cheese", 110, 70);
        System.out.println(bagOfChips1.displayInfo());
        ...
        list.add(bottleOfJuice1);
        list.add(candyBar1);
        list.add(bagOfChips1);
