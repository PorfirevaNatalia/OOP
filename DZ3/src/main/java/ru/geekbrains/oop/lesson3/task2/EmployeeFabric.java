...
public class EmployeeFabric {
    ...
    public static Staff generateStaff(){
        String [] position = new String[] { "Рабочий", "Инженер", "Менеджер", "Фрилансер" };
        String[] names = new String[] { "Анатолий", "Глеб", "Клим", "Мартин", "Лазарь", "Владлен", "Клим", "Панкратий", "Рубен", "Герман", "Игорь", "Илья", "Артём" };
